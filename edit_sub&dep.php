...
$id = trim($_GET['subdep_id']);
$fetch3 = mysqli_fetch_array(mysqli_query($conn, "select * from faculty_sub where id='" . $id . "'"));
...
if (isset($_POST['submit'])) {
  ...
  $query = "update faculty_sub set sub_cod='" . $sub_cod . "',sub_name='" . $sub_name . "',department='" . $department . "',faculty_id='" . $faculty_id . "',sem='" . $sem . "' where id='" . $id . "'";
  if (mysqli_query($conn, $query)) {
    //copy($temp,"img/products/".$newname);
    echo '<script>alert("Subject and Department Edit successfully");</script>';
        ...
        <div class="col-12 col-md-12 col-lg-12">
          <div class="card">
            <div class="card-header">
              <h4>Edit Subject And Department</h4>
            </div>
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data" action="#">
                <div class="row">
                  <div class="form-group col-6">
                    ...
                    <input id="sub_cod" type="text" value="<?= $fetch3['sub_cod']; ?>" class="form-control" name="sub_cod">
                  </div>
                  <div class="form-group col-6">
                    <label for="sub_name">Subject Name</label>
                    <input id="sub_name" type="text" value="<?= $fetch3['sub_name']; ?>" class="form-control" name="sub_name">
                  </div>
                  ...
                  ?>
                      ...
                      ?>
                        ...
                        <select name="department" value="<?= $fetch3['department']; ?>" class="form-control selectric" required>
                        ...
                        ?>
                            ...
                            ?>
                              ...
                              <select name="sem" value="<?= $fetch3['sem']; ?>" class="form-control selectric" required>
                              ...
                              ?>
                                  <div class="form-group col-4">
                                    <label>Faculty</label>
                                    <select name="faculty_id" value="<?= $fetch3['sem']; ?>" class="form-control selectric" required>
                                      <?php
