          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-striped">
                ...
                if ($d == "admin") {
                  $i = 0;
                  $queryuser = "select * from assignment order by id desc";
                ...
                ?>
                    <tr>
                      ...
                      <td><?= $row['date']; ?></td>
                      <td>
                        <a href="delete.php?assignment_all_id=<?= $row['id']; ?>">
                          <div class="badge badge-danger">Delete</div>
                        </a>
                      </td>
                      <td><a href="<?= $row['assignment']; ?>" class="btn btn-outline-primary">Detail</a></td>
                    </tr>
                    <?php
                    $i++;
                  }
                  ...
                  $i = 0;
                  $queryuser = "select * from assignment where (department='" . $fetch['department'] . "' AND sem='" . $fetch['current_semester'] . "') OR (department='All' OR sem='All') order by id desc";
                  $queryuserprofile = mysqli_query($conn, $queryuser);
                  while ($row = mysqli_fetch_array($queryuserprofile)) {
                    ?>
                    <tr>
                      ...
                      <td>
                        <?php
                        $que = mysqli_fetch_array(mysqli_query($conn, "select * from assignment_data where assid='" . $row['id'] . "' AND stdid='" . $_SESSION['id'] . "'"));
                        if ($que != null) {
                        ?>
                        ...
                        ?>
                          <a href="assignment_add_data.php?assignment_id=<?= $row['id']; ?>" class="btn btn-outline-primary">Add Data</a>
                        <?php
                        }
                        ?>
                      </td>
