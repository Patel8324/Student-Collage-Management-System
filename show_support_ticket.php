          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-striped">
                ...
                <?php
                $i = 0;
                $queryuser = "select * from suport order by id desc";
                ...
                ?>
                  <tr>
                    ...
                    ?>
                        <td>
                          <a href="delete.php?support_id=<?= $row['id']; ?>">
                    ...
                    ?>
                    <td><a href="<?= $row['suport']; ?>" class="btn btn-outline-primary">Detail</a></td>
                  </tr>
                <?php
                  $i++;
                }
